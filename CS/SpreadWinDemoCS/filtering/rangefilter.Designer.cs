namespace SpreadWinDemo.filtering
{
    partial class rangefilter
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rangefilter));
            ...
            this.Description = "セル範囲を指定した上でAutoFilterメソッドを呼び出すことにより、セル範囲にフィルタリング・ソート機能を設定することができます。";
            this.Name = "rangefilter";
            this.Title = "セル範囲のフィルタリング";
