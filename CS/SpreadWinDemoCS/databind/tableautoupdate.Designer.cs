namespace SpreadWinDemo.databind
{
    partial class tableautoupdate
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(tableautoupdate));
            ...
            this.Description = "フィルタで特定のアイテムを除外した状態で手動でセルを編集したりデータソースを変更した時に、変更後の値に自動的にフィルタを適用しテーブルの状態を維持します。";
            this.Name = "tableautoupdate";
            this.Title = "テーブルフィルタの自動更新";
