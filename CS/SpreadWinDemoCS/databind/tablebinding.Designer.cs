namespace SpreadWinDemo.databind
{
    partial class tablebinding
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(tablebinding));
            ...
            this.Description = "ITableインターフェースに用意されているDataSourceプロパティにデータセット割り当てることで、データセットをテーブルに連結することができます。";
            this.Name = "tablebinding";
            this.Title = "テーブルへのデータバインディング";
