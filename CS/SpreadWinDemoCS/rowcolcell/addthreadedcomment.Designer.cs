namespace SpreadWinDemo.rowcolcell
{
    partial class addthreadedcomment
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(addthreadedcomment));
            ...
            this.Description = "セルに対してスレッド形式のコメントを追加し、さらに返信を行ったりすることができます。シートの入力データに対してディスカッションを実現することができます。";
            this.Name = "addthreadedcomment";
            this.Title = "スレッド形式のコメント";
