namespace SpreadWinDemo.rowcolcell
{
    partial class rowheaderautowidth
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "行ヘッダの自動拡張を有効にする";
            ...
            this.Description = "垂直スクロールを下に移動させると行数を表示するヘッダのテキストが長くなり完全には表示されなくなりますが、行ヘッダの幅を自動で拡張してテキストを表示する機能が追加されました。";
            this.Name = "rowheaderautowidth";
            this.Title = "行ヘッダの自動拡張";
