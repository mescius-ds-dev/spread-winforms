namespace SpreadWinDemo.rowcolcell
{
    partial class rowvisible
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "行や列のVisibleプロパティをFalseに設定することで任意の行や列を非表示にすることができます。";
            this.Name = "rowvisible";
            this.Title = "行、列の非表示";
