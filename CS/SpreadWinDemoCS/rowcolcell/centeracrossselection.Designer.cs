namespace SpreadWinDemo.rowcolcell
{
    partial class centeracrossselection
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(centeracrossselection));
            ...
            this.Description = "セルを結合せず中央に揃える「選択範囲内で中央」機能が追加されました。セルの結合を行うと集計や編集が正しく行われない場合があり、それを回避しつつ中央揃えを実現できま" +
    "す。";
            this.Name = "centeracrossselection";
            this.Title = "選択範囲内で中央";
