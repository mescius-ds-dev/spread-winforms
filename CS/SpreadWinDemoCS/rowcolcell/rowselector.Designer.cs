namespace SpreadWinDemo.rowcolcell
{
    partial class rowselector
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "行が選択されたらインジケータを表示する";
            ...
            this.checkBox2.Text = "値が変更されたらインジケータを変更する";
            ...
            this.Description = "行が選択されたことを示す三角形のインジケータを行ヘッダに表示できます。セルの値を変更しているときにインジケータを変更することもできます。";
