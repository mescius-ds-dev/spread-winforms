...
{
    partial class excelprintpreview
    {
        /// <summary>
        /// 必要なデザイナー変数です。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "EnhancePreviewプロパティを有効にすることでExcelライクな印刷プレビューを表示することができます。";
            this.Name = "excelprintpreview";
            this.Title = "Excelライクプレビュー";
