namespace SpreadWinDemo.print
{
    partial class excelprint
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(excelprint));
            ...
            this.Description = "複数のExcel互換の印刷機能がサポートされています。先頭ページや奇数／偶数ページで別指定のヘッダ／フッタを設定することや、部単位・ページ単位での印刷、よりExc" +
    "elライクな印刷を実現できるExcel互換印刷がサポートされます。";
            this.Name = "excelprint";
            this.Title = "Excel互換の印刷機能";
