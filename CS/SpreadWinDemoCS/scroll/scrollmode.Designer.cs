namespace SpreadWinDemo.scroll
{
    partial class scrollmode
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "スクロールする単位を設定できます。Pixel単位に設定すると、縦や横に長く伸びる内容をスクロールしながら確認できます。";
            this.Name = "scrollmode";
            this.Title = "スクロール単位";
