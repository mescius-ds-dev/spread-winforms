namespace SpreadWinDemo.scroll
{
    partial class mousewheel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "システムで設定されているマウスホイールの移動量とVerticalScrollBarSmallChangeプロパティの値を使用してピクセルスクロールの移動量を設定できます。トラックバーではVerticalScrollBarSmallChangeプロパティの値を変更できます。";
            this.Name = "mousewheel";
            this.Title = "マウスホイールのピクセルスクロール";
