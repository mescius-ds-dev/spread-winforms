namespace SpreadWinDemo.scroll
{
    partial class scrollbartrack
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "遅延スクロールを有効にする";
            ...
            this.checkBox2.Text = "スクロールチップを表示する";
            ...
            this.Description = "ユーザーがスクロールバーのつまみを離してから該当する領域を表示できます。スクロール中は表示が更新されないため、スクロールの性能が向上します。";
            this.Name = "scrollbartrack";
            this.Title = "遅延スクロール";
