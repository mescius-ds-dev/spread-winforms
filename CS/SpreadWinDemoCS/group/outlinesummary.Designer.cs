namespace SpreadWinDemo.group
{
    partial class outlinesummary
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "展開／縮小ボタンを下に表示する";
            ...
            this.checkBox2.Text = "展開／縮小ボタンを右に表示する";
            ...
            this.Description = "アウトラインの展開／縮小ボタンの位置を設定（上／下または右／左）することができます。";
            this.Name = "outlinesummary";
            this.Title = "アウトラインのボタン位置";
