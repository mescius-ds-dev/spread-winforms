namespace SpreadWinDemo.importexport
{
    partial class saveexcelfile
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Excel（xls）出力";
            ...
            this.button2.Text = "Excel（xlsx）出力";
            ...
            this.Description = "SaveExcel メソッドにより、SPREADのデータを Excelファイルに保存することができます。";
            this.Name = "saveexcelfile";
            this.Title = "Excelファイルへ保存";
