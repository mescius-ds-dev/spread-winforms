namespace SpreadWinDemo.importexport
{
    partial class savetextfile
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "SaveTextFile メソッドにより、 シート内のデータまたは書式付きデータは、デフォルトのタブ区切り形式、または独自の区切り形式によってテキストファイルに保" +
    "存できます。";
            this.Name = "savetextfile";
            this.Title = "csv（テキスト）ファイルへ保存";
