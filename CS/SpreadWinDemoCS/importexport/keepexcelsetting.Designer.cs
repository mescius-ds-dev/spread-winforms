namespace SpreadWinDemo.importexport
{
    partial class keepexcelsetting
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button2.Text = "Excelファイルのエクスポート";
            ...
            this.Description = "Excelファイルの情報（マクロやフォームコントロール）を維持したまま、Excelファイルをインポートしてエクスポートすることができます。";
            this.Name = "keepexcelsetting";
            this.Title = "Excelファイルの読込と保存（Excel情報の維持）";
