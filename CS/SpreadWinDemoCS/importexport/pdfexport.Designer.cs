namespace SpreadWinDemo.importexport
{
    partial class pdfexport
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(pdfexport));
            ...
            this.Description = "新しいPDFエクスポート機能では、よりExcelに近い形式のPDFファイルを保存することができます。Excelのようなセルの書式、透過度を有効にしたシェイプ、リッチテキストなどのエクスポートなどが可能です。";
            this.Name = "pdfexport";
            this.Title = "新しいPDFエクスポート";
