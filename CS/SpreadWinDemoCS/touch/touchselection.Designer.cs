namespace SpreadWinDemo.touch
{
    partial class touchselection
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.comboBox1.Text = "選択グリッパーの線の太さ：1";
            // 
            // splitContainer3
            // 
            ...
            this.Description = "タッチ操作でセルをタップするとグリッパー（丸い選択ハンドル）を表示します。グリッパーを使用するとセルの選択範囲を変更することができます。";
            this.Name = "touchselection";
            this.Title = "選択グリッパー";
