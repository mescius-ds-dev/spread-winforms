namespace SpreadWinDemo.edit
{
    partial class useclipboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "クリップボード機能を有効化";
            ...
            this.checkBox2.Size = new System.Drawing.Size(352, 30);
            this.checkBox2.TabIndex = 0;
            this.checkBox2.Text = "クリップボード機能にヘッダを含める";
            ...
            this.Description = "クリップボードを使用したコピー＆ペースト機能が実現できます。 SPREADのデータをクリップボードにコピーしたり、クリップボードのデータをSPREADにペーストす" +
    "ることができます。";
            this.Name = "useclipboard";
            this.Title = "クリップボード";
