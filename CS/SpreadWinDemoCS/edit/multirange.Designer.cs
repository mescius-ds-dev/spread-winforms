namespace SpreadWinDemo.edit
{
    partial class multirange
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(multirange));
            ...
            this.Description = "RichClipboardプロパティを有効にすることで複数範囲のコピー＆ペーストを実現できます。単一のセル範囲をコピーして複数のセル範囲にペーストすることや、複数" +
    "のセル範囲をコピーして単一のセル範囲にペーストすることが可能です。";
            this.Name = "multirange";
            this.Title = "複数範囲のコピー＆ペースト";
