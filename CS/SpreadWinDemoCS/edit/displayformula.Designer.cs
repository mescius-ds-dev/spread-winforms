namespace SpreadWinDemo.edit
{
    partial class displayformula
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "セルを非編集の時でも数式を表示することが可能なDisplayFormulasプロパティが追加されました。サンプルでは合計列に数式が設定されています。";
            this.Name = "displayformula";
            this.Title = "数式の表示";
