namespace SpreadWinDemo.edit
{
    partial class autoformat
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(autoformat));
            ...
            this.checkBox1.Size = new System.Drawing.Size(352, 30);
            this.checkBox1.TabIndex = 0;
            this.checkBox1.Text = "数式のオートフォーマットを有効にする";
            ...
            this.Description = "数式のオートフォーマット機能は数式が返すデータ型によって結果の値を自動的に書式設定します。日付値や数値を返す関数の場合には日付書式や数値書式が適用され、セルを参照" +
    "している場合には参照先の書式が適用されます。";
            this.Name = "autoformat";
            this.Title = "数式のオートフォーマット";
