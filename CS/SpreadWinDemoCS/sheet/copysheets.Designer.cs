namespace SpreadWinDemo.sheet
{
    partial class copysheets
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Sheet1とSheet2をコピー";
            ...
            this.Description = "複数シートのコピーをサポートします。複数のシート（セルの参照先／参照元のシートの両方）を同時にコピーすると、コピーされた複数のシート内で参照状態が作成されます。";
            this.Name = "copysheets";
            this.Title = "複数シートのコピー";
