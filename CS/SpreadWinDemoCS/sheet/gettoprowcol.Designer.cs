namespace SpreadWinDemo.sheet
{
    partial class gettoprowcol
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "GetViewportTopRowメソッドにより、 シート（ビューポート）上表示されている一番上のセルの行インデックスを、 GetViewportLeftColu" +
    "mnメソッドにより、シート（ビューポート）上表示されている 一番左のセルの列インデックスを取得することができます。";
            this.Name = "gettoprowcol";
            this.Title = "先頭セルの取得";
