namespace SpreadWinDemo.selection
{
    partial class paintselectionheader
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "ヘッダセルをハイライト表示する";
            ...
            this.Description = "PaintSelectionHeaderプロパティにて選択範囲のヘッダセルの背景色をハイライト表示するかを設定することができます。";
            this.Name = "paintselectionheader";
            this.Title = "ヘッダのハイライト表示";
