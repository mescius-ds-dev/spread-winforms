namespace SpreadWinDemo.selection
{
    partial class cellspanselection
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Description = "結合されたヘッダセルをクリックしたときの選択範囲を指定できます。 結合されたセルの左の列（上の行）のみを選択、ヘッダ領域に収まるセルだけを選択、ヘッダの領域に含ま" +
    "れるセルをすべて選択などのパターンで選択方法を設定できます。";
            this.Name = "cellspanselection";
            this.Title = "ヘッダクリック時の選択範囲";
