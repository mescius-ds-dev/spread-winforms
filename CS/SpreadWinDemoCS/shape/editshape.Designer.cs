namespace SpreadWinDemo.shape
{
    partial class editshape
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(editshape));
            ...
            this.fpSpread1.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
            ...
            this.Description = "シェイプの頂点を編集できるようになりました。シェイプを右クリックして「頂点の編集」を選択することでExcelと同じように図形のポイントを編集することができます。";
            this.Name = "editshape";
            this.Title = "シェイプの頂点の編集";
