...
Partial Class cellformat
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(cellformat))
        ...
        Me.Description = "通貨、日付、時刻などの様々な書式をセルに設定することが可能です。書式の設定はIRangeインタフェースのNumberFormatプロパティを使用します。"
        Me.Name = "cellformat"
        Me.Title = "セルの書式設定"
