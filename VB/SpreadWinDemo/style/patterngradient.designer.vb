...
Partial Class patterngradient
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(patterngradient))
        ...
        Me.Description = "Excelで提供される豊富なパターンとグラデーションと同等のスタイルをSPREADでも適用することが可能です。"
        Me.Name = "patterngradient"
        Me.Title = "パターンとグラデーション"
