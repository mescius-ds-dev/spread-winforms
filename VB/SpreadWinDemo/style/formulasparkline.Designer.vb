...
Partial Class formulasparkline
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(formulasparkline))
        ...
        Me.Description = "セルに数式を設定してスパークラインを作成できるようになります。すでにサポートされている3種類のスパークラインに加えて、新たに17種類のスパークラインを数式を使用し" &
    "て設定できます。サンプルでは面スパークラインを実装しています。"
        Me.Name = "formulasparkline"
        Me.Title = "数式を使用したスパークライン"
