...
Partial Class rangefilter
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rangefilter))
        ...
        Me.Description = "セル範囲を指定した上でAutoFilterメソッドを呼び出すことにより、セル範囲にフィルタリング・ソート機能を設定することができます。"
        Me.Name = "rangefilter"
        Me.Title = "セル範囲のフィルタリング"
