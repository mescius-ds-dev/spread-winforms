...
Partial Class excelprint
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(excelprint))
        ...
        Me.Description = "複数のExcel互換の印刷機能がサポートされています。先頭ページや奇数／偶数ページで別指定のヘッダ／フッタを設定することや、部単位・ページ単位での印刷、よりExc" &
    "elライクな印刷を実現できるExcel互換印刷がサポートされます。"
        Me.Name = "excelprint"
        Me.Title = "Excel互換の印刷機能"
