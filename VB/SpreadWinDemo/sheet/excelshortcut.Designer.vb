...
Partial Class excelshortcut
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(excelshortcut))
        ...
        Me.CheckBox1.Text = "Excel互換のショートカットキーを有効にする"
        ...
        Me.Description = "シートでのショートカットキーとテーブルでのショートカットキーを設定できます。使用できる主なショートカットキーは「種類」シートに記載されています。"
        Me.Name = "excelshortcut"
        Me.Title = "Excel互換のショートカットキー"
