...
Partial Class copysheets
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "Sheet1とSheet2をコピー"
        ...
        Me.Description = "複数シートのコピーをサポートします。複数のシート（セルの参照先／参照元のシートの両方）を同時にコピーすると、コピーされた複数のシート内で参照状態が作成されます。"
        Me.Name = "copysheets"
        Me.Title = "複数シートのコピー"
