...
Partial Class autotable
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(autotable))
        ...
        Me.Description = "テーブルの下の行／右の列が空の場合に、ユーザーがそのセル範囲に値を入力するとテーブルの範囲が自動で拡張されます。また、空のテーブル列に数式を入力すると入力された数" &
    "式で列を埋めます。以下のサンプルではセルE3に「=1」と入力すると合計列のすべてに同じ数式が設定されます。"
        Me.Name = "autotable"
        Me.Title = "テーブルの自動拡張"
