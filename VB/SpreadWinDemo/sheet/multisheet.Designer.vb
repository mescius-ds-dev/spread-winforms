...
Partial Class multisheet
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "SPREADコントロールには、1つまたは複数のシートを追加できます。 デフォルトでは、コントロールは「Sheet 1」という名前の１つのシートを持ち、 このシート" & _
    "は「インデックス0」として参照されます （シートのインデックスは0から始まる）。"
        Me.Name = "multisheet"
        Me.Title = "マルチシート"
