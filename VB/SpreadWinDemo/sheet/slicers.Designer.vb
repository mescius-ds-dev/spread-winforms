...
Partial Class slicers
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(slicers))
        ...
        Me.Description = "ワークシート内でのスライサー（視覚的フィルター）の使用をサポートしています。スライサーを使用するとドロップダウンリストを使用せずにテーブル内のデータを素早くフィル" &
    "タリングできます。"
        Me.Name = "slicers"
        Me.Title = "スライサー"
