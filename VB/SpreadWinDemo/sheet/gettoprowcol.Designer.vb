...
Partial Class gettoprowcol
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "GetViewportTopRowメソッドにより、 シート（ビューポート）上表示されている一番上のセルの行インデックスを、 GetViewportLeftColu" & _
    "mnメソッドにより、シート（ビューポート）上表示されている 一番左のセルの列インデックスを取得することができます。"
        Me.Name = "gettoprowcol"
        Me.Title = "先頭セルの取得"
