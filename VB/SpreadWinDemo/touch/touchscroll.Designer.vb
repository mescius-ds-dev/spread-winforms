...
Partial Class touchscroll
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"スクロール方向：スクロールなし", "スクロール方向：水平方向のみ", "スクロール方向：垂直方向のみ", "スクロール方向：水平または垂直方向", "スクロール方向：水平、垂直および斜め方向"})
        ...
        Me.ComboBox2.Items.AddRange(New Object() {"バウンドの動作：フォーム画面", "バウンドの動作：固定領域（ヘッダ領域）以外"})
        ...
        Me.Description = "タッチ操作でスクロールできる方向やシートの端にスクロールが到達したときの動作を設定することができます。"
        Me.Name = "touchscroll"
        Me.Title = "タッチスクロール"
