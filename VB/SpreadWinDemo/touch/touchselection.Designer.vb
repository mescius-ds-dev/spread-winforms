...
Partial Class touchselection
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"選択グリッパーの線の太さ：1", "選択グリッパーの線の太さ：2", "選択グリッパーの線の太さ：3", "選択グリッパーの線の太さ：4"})
        ...
        Me.Description = "タッチ操作でセルをタップするとグリッパー（丸い選択ハンドル）を表示します。グリッパーを使用するとセルの選択範囲を変更することができます。"
        Me.Name = "touchselection"
        Me.Title = "選択グリッパー"
