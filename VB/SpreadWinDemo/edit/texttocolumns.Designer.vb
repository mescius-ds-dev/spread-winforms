...
Partial Class texttocolumns
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "単一のセルに含まれる区切り文字を含むテキストを別々の列に設定します。テキストエディタにコピーしてから1つずつ異なるセルに再設定する必要はなくなるので利便性が向上します。"
        Me.Name = "texttocolumns"
        Me.Title = "テキストから列"
