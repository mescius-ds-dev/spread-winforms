...
Partial Class autoformat
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(autoformat))
        ...
        Me.CheckBox1.Text = "数式のオートフォーマットを有効にする"
        ...
        Me.Description = "数式のオートフォーマット機能は数式が返すデータ型によって結果の値を自動的に書式設定します。日付値や数値を返す関数の場合には日付書式や数値書式が適用され、セルを参照" &
    "している場合には参照先の書式が適用されます。"
        Me.Name = "autoformat"
        Me.Title = "数式のオートフォーマット"
