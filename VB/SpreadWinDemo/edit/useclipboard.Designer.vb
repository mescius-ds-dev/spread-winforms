...
Partial Class useclipboard
    ...
    Private Sub InitializeComponent()
        ...
        Me.CheckBox1.Text = "クリップボード機能を有効化"
        ...
        Me.CheckBox2.Text = "クリップボード機能にヘッダを含める"
        ...
        Me.Description = "クリップボードを使用したコピー＆ペースト機能が実現できます。 SPREADのデータをクリップボードにコピーしたり、クリップボードのデータをSPREADにペーストす" & _
    "ることができます。"
        Me.Name = "useclipboard"
        Me.Title = "クリップボード"
