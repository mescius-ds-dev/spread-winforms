...
Partial Class multirange
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(multirange))
        ...
        Me.Description = "RichClipboardプロパティを有効にすることで複数範囲のコピー＆ペーストを実現できます。単一のセル範囲をコピーして複数のセル範囲にペーストすることや、複数" &
    "のセル範囲をコピーして単一のセル範囲にペーストすることが可能です。"
        Me.Name = "multirange"
        Me.Title = "複数範囲のコピー＆ペースト"
