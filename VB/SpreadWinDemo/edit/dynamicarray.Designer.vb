...
Partial Class dynamicarray
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "配列数式を拡張した動的配列数式をサポートします。動的配列数式は、セル範囲を自動的にスピルすることで複数の結果を出力として返します。このサンプルでは、SORTBY関数を使ってSheet2の「数量」列を基準にすべての列をソートしSheet1に表示しています。"
        Me.Name = "dynamicarray"
        Me.Title = "動的配列数式"
