...
Partial Class outlinesummary
    ...
    Private Sub InitializeComponent()
        ...
        Me.CheckBox1.Text = "展開／縮小ボタンを下に表示する"
        ...
        Me.CheckBox2.Text = "展開／縮小ボタンを右に表示する"
        ...
        Me.Description = "アウトラインの展開／縮小ボタンの位置を設定（上／下または右／左）することができます。"
        Me.Name = "outlinesummary"
        Me.Title = "アウトラインのボタン位置"
