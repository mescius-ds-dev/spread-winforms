...
Partial Class pdfexport
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(pdfexport))
        ...
        Me.Description = "新しいPDFエクスポート機能では、よりExcelに近い形式のPDFファイルを保存することができます。Excelのようなセルの書式、透過度を有効にしたシェイプ、リッ" &
    "チテキストなどのエクスポートなどが可能です。"
        Me.Name = "pdfexport"
        Me.Title = "新しいPDFエクスポート"
