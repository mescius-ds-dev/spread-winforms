...
Partial Class saveexcelfile
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "SaveExcel メソッドにより、SPREADのデータを Excelファイルに保存することができます。"
        Me.Name = "saveexcelfile"
        Me.Title = "Excelファイルへ保存"
