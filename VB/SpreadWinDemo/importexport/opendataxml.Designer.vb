...
Partial Class opendataxml
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(opendataxml))
        ...
        Me.Button1.Text = "XMLデータファイルのインポート"
        ...
        Me.Description = "IWorkbooksインターフェースのOpenXMLメソッドを呼び出すことで一般的なXMLファイルを読み込むことができます。"
        Me.Name = "opendataxml"
        Me.Title = "XMLデータファイルの読込"
