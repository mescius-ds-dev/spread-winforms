...
Partial Class savetextfile
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "SaveTextFile メソッドにより、 シート内のデータまたは書式付きデータは、デフォルトのタブ区切り形式、または独自の区切り形式によってテキストファイルに保" & _
    "存できます。"
        Me.Name = "savetextfile"
        Me.Title = "csv（テキスト）ファイルへ保存"
