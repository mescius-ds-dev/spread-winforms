...
Partial Class customcomparison
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "メールアドレスのドメインでソート"
        ...
        Me.Description = "データの比較方法を独自に定義したIComparerを指定してSortRowsメソッドを実行することで、独自のソート方法でソートすることができます。"
        Me.Name = "customcomparison"
        Me.Title = "独自のソートロジックでソート"
