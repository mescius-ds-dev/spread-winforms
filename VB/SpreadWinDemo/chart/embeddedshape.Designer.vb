...
Partial Class embeddedshape
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(embeddedshape))
        ...
        Me.Description = "チャート内にシェイプを埋め込むことが可能です。シェイプはチャート内のオブジェクトとなるためチャートの外に移動させることはできません。"
        Me.Name = "embeddedshape"
        Me.Title = "チャートへシェイプの埋め込み"
