Public Class areachart
    ...
    Private Sub InitSheet(sheet As FarPoint.Win.Spread.SheetView)
        ...
        ' シリーズを作成
        Dim series1 As New FarPoint.Win.Chart.AreaSeries()
        ...
        Dim series2 As New FarPoint.Win.Chart.AreaSeries()
        ...
        Dim series3 As New FarPoint.Win.Chart.AreaSeries()
        ...
        Dim series4 As New FarPoint.Win.Chart.AreaSeries()
