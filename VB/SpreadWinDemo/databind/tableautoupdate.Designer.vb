...
Partial Class tableautoupdate
    ...
    Private Sub InitializeComponent()
        ...
        Me.Description = "フィルタで特定のアイテムを除外した状態で手動でセルを編集したりデータソースを変更した時に、変更後の値に自動的にフィルタを適用しテーブルの状態を維持します。"
        Me.Name = "touchkeyboard"
        Me.Title = "テーブルフィルタの自動更新"
