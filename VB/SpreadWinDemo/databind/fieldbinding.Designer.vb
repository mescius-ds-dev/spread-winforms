...
Partial Class fieldbinding
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"全データを連結", "計画データのみを連結", "実績データのみを連結"})
        ...
        Me.Description = "列のDataFieldプロパティを使用すると、表示フィールドの位置（順番）を変更したり、ある特定のフィールドのみを連結することができます。"
        Me.Name = "fieldbinding"
        Me.Title = "特定の列だけを連結"
