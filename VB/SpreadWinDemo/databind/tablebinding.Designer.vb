...
Partial Class tablebinding
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(tablebinding))
        ...
        Me.Description = "ITableインターフェースに用意されているDataSourceプロパティにデータセット割り当てることで、データセットをテーブルに連結することができます。"
        Me.Name = "tablebinding"
        Me.Title = "テーブルへのデータバインディング"
