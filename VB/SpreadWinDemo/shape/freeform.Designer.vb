...
Partial Class freeform
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button2.Text = "フリーフォーム：フリーハンド"
        ...
        Me.Description = "マウスを使用してシェイプを描画することが可能です。シェイプは曲線と直線のセグメントを持つ図を描画し、フリーハンドは手書きでペンで描いたような形を描いたり、なめらか" &
    "な曲線を描いたりすることができます。"
        Me.Name = "freeform"
        Me.Title = "先頭セルの取得"
