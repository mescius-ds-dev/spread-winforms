...
Partial Class scrollmode
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"行方向スクロール単位：行", "行方向スクロール単位：行（スクロール中はピクセル）", "行方向スクロール単位：ピクセル"})
        ...
        Me.ComboBox2.Items.AddRange(New Object() {"列方向スクロール単位：列", "列方向スクロール単位：列（スクロール中はピクセル）", "列方向スクロール単位：ピクセル"})
        ...
        Me.Description = "スクロールする単位を設定できます。Pixel単位に設定すると、縦や横に長く伸びる内容をスクロールしながら確認できます。"
        Me.Name = "scrollmode"
        Me.Title = "スクロール単位"
