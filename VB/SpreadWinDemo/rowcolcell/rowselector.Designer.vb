...
Partial Class rowselector
    ...
    Private Sub InitializeComponent()
        ...
        Me.CheckBox1.Text = "行が選択されたらインジケータを表示する"
        ...
        Me.CheckBox2.Text = "値が変更されたらインジケータを変更する"
        ...
        Me.Description = "行が選択されたことを示す三角形のインジケータを行ヘッダに表示できます。セルの値を変更しているときにインジケータを変更することもできます。"
        Me.Name = "rowselector"
        Me.Title = "行セレクタ"
