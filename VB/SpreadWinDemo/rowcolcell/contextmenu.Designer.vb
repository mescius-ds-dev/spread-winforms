...
Partial Class contextmenu
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(contextmenu))
        ...
        Me.Description = "製品機能としてコンテキストメニューが用意されており簡単に組み込むことが可能です。右クリックする位置（行ヘッダ、列ヘッダ、セル、シートコーナー）によって適切なメニューアイテムが表示されます。"
        Me.Name = "contextmenu"
        Me.Title = "コンテキストメニュー"
