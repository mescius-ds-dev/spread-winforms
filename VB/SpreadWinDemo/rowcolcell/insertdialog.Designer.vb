...
Partial Class insertdialog
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(insertdialog))
        ...
        Me.Description = "コピーしたセルや列、行を挿入する際に［挿入］ダイアログが使えるようになります。［挿入］ダイアログはCtrl + Shift + ""+""をタイプすると表示されます。" &
    ""
        Me.Name = "insertdialog"
        Me.Title = "挿入ダイアログ"
