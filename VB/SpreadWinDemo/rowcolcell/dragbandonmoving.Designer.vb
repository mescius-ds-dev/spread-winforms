...
Partial Class dragbandonmoving
    ...
    Private Sub InitializeComponent()
        ...
        Me.CheckBox1.Text = "行列のドラッグ移動時にドラッグバンドを表示する"
        ...
        Me.Description = "デフォルトでは、行列のドラッグ移動時にドラッグバンドが表示されます。ShowDragBandOnMovingプロパティをFalseに設定することでドラッグ移動時の" & _
    "アニメーションを簡素化させ、パフォーマンスを改善することができます。"
        Me.Name = "dragbandonmoving"
        Me.Title = "行列ドラッグ移動のアニメーション"
