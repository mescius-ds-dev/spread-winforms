...
Partial Class operationmode
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"標準モード（標準的な操作）", "読み取り専用モード（一切の変更を禁止）", "行モード（セル編集可能な行選択モード）", "単一選択モード（1つの行のみ選択）", "複数選択モード（複数の行の選択）", "拡張選択モード（[Ctrl]+クリック／[Shift]+方向キーで複数行選択）"})
        ...
        Me.Description = "選択動作やユーザの操作への対応を変更するには、OperationModeプロパティを設定します。"
        Me.Name = "operationmode"
        Me.Title = "オペレーションモード"
