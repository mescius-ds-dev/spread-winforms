...
Partial Class selectionpolicy
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"0.単一セル", "1.セル", "2.行", "3.行とセル", "4.列", "5.列とセル", "6.列と行", "7.列と行とセル", "8.シート", "9.デフォルト"})
        ...
        Me.Description = "SelectionBlockOptionsプロパティにて、クライアントで選択できる選択範囲の種類を 選べます。選択範囲の種類は、「セル」「行」「列」「シート」を " & _
    "組み合わせて設定することができます。"
        Me.Name = "selectionpolicy"
        Me.Title = "選択のカスタマイズ"
